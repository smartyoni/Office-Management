...
type IconProps = {
  name: 'upload' | 'edit' | 'delete' | 'add' | 'close' | 'filter' | 'search' | 'chevron_left' | 'chevron_right';
  className?: string;
};
  ...
  const icons: Record<string, React.ReactNode> = {
    upload: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 16.5V9.75m0 0l-3.75 3.75M12 9.75l3.75 3.75M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 15v6h6v-6" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 15l-3-3m0 0l3-3m-3 3h12" />
